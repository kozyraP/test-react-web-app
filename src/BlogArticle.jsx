    ...
    return (
        <>
            ...
            <div className="prose mt-8 prose  mx-auto lg:prose-lg">
                ...
                <p>It adds a new <code>prose</code> className that you can slap on any block of vanilla HTML content and turn it into a beautiful, well-formatted document:</p>
